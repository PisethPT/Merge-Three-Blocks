...
public class OnEnterMouseRuleFour : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        if (TransformPositions.countObjectTransform < 5)
        {
            ...
            InstantiateDices.count3--;
            InstantiateDices.isInstantiate3 = true;
            ...
            IEnumerator DestroyObject()
            {
                ...
                Destroy(transform.GetComponent<OnEnterMouseRuleFour>());
            }
        }
    }
