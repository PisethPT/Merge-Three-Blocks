...
public class OnEnterMouseRuleOne : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        if (TransformPositions.countObjectTransform < 5)
        {
            ...
            InstantiateDices.count--;
            InstantiateDices.isInstantiate = true;
            ...
            IEnumerator DestroyObject()
            {
                ...
                Destroy(transform.GetComponent<OnEnterMouseRuleOne>());
            }
        }
    }
