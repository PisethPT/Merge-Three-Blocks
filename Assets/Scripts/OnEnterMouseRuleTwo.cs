...
public class OnEnterMouseRuleTwo : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        if (TransformPositions.countObjectTransform < 5)
        {
            ...
            InstantiateDices.count1--;
            InstantiateDices.isInstantiate1 = true;
            ...
            IEnumerator DestroyObject()
            {
                ...
                Destroy(transform.GetComponent<OnEnterMouseRuleTwo>());
            }
        }
    }
