...
public class OnEnterMouseRuleFive : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        if (TransformPositions.countObjectTransform < 5)
        {
            ...
            InstantiateDices.count4--;
            InstantiateDices.isInstantiate4 = true;
            ...
            IEnumerator DestroyObject()
            {
                ...
                Destroy(transform.GetComponent<OnEnterMouseRuleFive>());
            }
        }
    }
